function [time,traj_yp_cart,retval]=gen_primitives_abbassa(prim_data)
...
[time,~,traj_yp_cart,~,~,retval] = min_jerk_trajectory_analytic(x0,xf,Ts,state_bounds,control_bounds);
