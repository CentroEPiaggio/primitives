classdef WheelDrop < robotics.ros.Message
    %WheelDrop MATLAB implementation of irobotcreate2/WheelDrop
    ...
    properties (Constant)
        MessageType = 'irobotcreate2/WheelDrop' % The ROS message type
    end
    ...
    methods
        function obj = WheelDrop(msg)
            %WheelDrop Construct the message object WheelDrop
        ...
        function set.Left(obj, left)
            ...
            validateattributes(left, {obj.Irobotcreate2RoombaSwitchClass}, {'nonempty', 'scalar'}, 'WheelDrop', 'left');
        ...
        function set.Right(obj, right)
            ...
            validateattributes(right, {obj.Irobotcreate2RoombaSwitchClass}, {'nonempty', 'scalar'}, 'WheelDrop', 'right');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.irobotcreate2.WheelDrop.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.irobotcreate2.WheelDrop;
            obj.reload(strObj);
        end
    end
end
